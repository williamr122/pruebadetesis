...
def build_prompt(
    *,
    ...
    - original_response: respuesta previa de YELIA a ampliar o referenciar
    - unidad_actual: unidad académica activa del estudiante
    ...
    system_prompt = (
        ...
        "   c) 3-4 bullets limpios listando temas en los que sí puedes ayudar (POO, Java, MVC, Archivos, BD/ORM, etc.),\n"
        "   d) 1 pregunta interactiva para motivar al estudiante.\n\n"
        ...
        "1) Un párrafo inicial muy corto (2–3 líneas) explaining la idea general.\n"
    ...
    if original_response:
        context_instruction = (
            "\n\n=== CONTEXTO DE AMPLIACIÓN O REFERENCIA (MUY IMPORTANTE) ===\n"
            "El estudiante está interactuando con respecto a una respuesta anterior específica que recibió de YELIA.\n"
            f"Unidad académica actual: Unidad {unidad_actual or 'No especificada'}\n"
            f"Respuesta anterior de referencia:\n"
            f"\"\"\"\n{original_response}\n\"\"\"\n\n"
            "Instrucción para YELIA:\n"
            "- Si el estudiante pide una explicación más clara ('Explícame mejor'), debes desglosar, clarificar y detallar los conceptos exactos de esta respuesta anterior de referencia.\n"
            "- Si el estudiante pide un ejemplo ('Dame ejemplo'), debes formular ejemplos prácticos, código o analogías directamente relacionados con los conceptos de esta respuesta anterior de referencia.\n"
            "- Si el estudiante pide un quiz ('Hazme quiz'), debes formular preguntas cortas (ej. formato 1a, 2b) que evalúen la comprensión sobre los conceptos clave de esta respuesta anterior de referencia.\n"
            "- Evita dar respuestas generales o descontextualizadas; usa la respuesta anterior de referencia para responder de forma específica y conectada."
        )
