              ...
              <div className="grid">
                <Field label="Contrasena" icon={<LockIcon />}>
                  <div style={{ position: 'relative', display: 'flex', alignItems: 'center', width: '100%' }}>
                    ...
                    >
                      <i className={`bi ${showSetupPwd ? 'bi-eye-slash-fill' : 'bi-eye-fill'}`}></i>
                    </span>
                    <input 
                      className="input" 
                      name="password" 
                ...
                <Field label="Confirmar contrasena" icon={<LockIcon confirm />}>
                  <div style={{ position: 'relative', display: 'flex', alignItems: 'center', width: '100%' }}>
                    <span 
                    ...
                    >
                      <i className={`bi ${showSetupConfirm ? 'bi-eye-slash-fill' : 'bi-eye-fill'}`}></i>
                    </span>
                    <input 
                      className="input" 
                      name="confirm" 
